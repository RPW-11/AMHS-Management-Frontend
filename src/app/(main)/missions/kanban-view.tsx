        ...
        <div className="grid grid-cols-3 gap-6">
            <div className="col-span-1 space-y-4">
                ...
                <div className="flex flex-col gap-4 p-2 rounded-md bg-gray-100">
                    ...
                    &&
                    <div className="text-sm text-center">{t("missions.kanban.noActiveMissions")}</div>
                    }
                </div>
            </div>
            <div className="col-span-1 space-y-4">
                <h3 className="font-bold text-sm flex items-center gap-2">
                    {t("missions.status.finished")}
                ...
                <div className="flex flex-col gap-4 p-2 rounded-md bg-gray-100">
                    ...
                    &&
                    <div className="text-sm text-center">{t("missions.kanban.noFinishedMissions")}</div>
                    }
                </div>
            </div>
            <div className="col-span-1 space-y-4">
                <h3 className="font-bold text-sm flex items-center gap-2">
                    {t("missions.status.inactive")}
                ...
                <div className="flex flex-col gap-4 p-2 rounded-md bg-gray-100">
                    ...
                    &&
                    <div className="text-sm text-center">{t("missions.kanban.noInactiveMissions")}</div>
                    }
                </div>
            </div>
        </div>
